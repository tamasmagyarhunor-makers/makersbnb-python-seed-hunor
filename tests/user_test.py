...
def test_user_constructs():
    user = User(3, "Tim", "098765", "tim@example.com", "07118118118")
    assert user.id == 3
    assert user.user_name == "Tim"
    assert user.password == "098765"
...
def test_user_object_formats_nicely():
    user = User(3, "Tim", "098765", "tim@example.com", "07118118118")
    assert str(user) == "User(3, Tim, 098765, tim@example.com, 07118118118)"
...
def test_user_objects_are_equal():
    user_1 = User(3, "Tim", "098765", "tim@example.com", "07118118118")
    user_2 = User(3, "Tim", "098765", "tim@example.com", "07118118118")
