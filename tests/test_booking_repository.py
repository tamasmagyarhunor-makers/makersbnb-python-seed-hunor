...
def test_add_invalid_booking(db_connection):
    db_connection.seed('seeds/makersbnb_seed.sql')
    repository = BookingRepository(db_connection)

    assert repository.add_booking('2025-01-01','2026-01-10',1,1) == 'not available'
    assert repository.find_by_space_id(1) == [
        Booking(1,'2025-10-01','2025-10-02',1,2)
    ]

    assert repository.add_booking('2025-10-01','2025-10-10',1,1) == 'already booked'
    assert repository.find_by_space_id(1) == [
        Booking(1,'2025-10-01','2025-10-02',1,2)
    ]
