...
def test_get_by_id(db_connection):
    ...
    assert repository.find_by_id(1) == Space('The Barn', 'Converted barn set in a rural location', 65, 1)
    assert repository.find_by_id(2) == Space('The Loft', 'City centre loft space with great access to amenities', 95, 1)
...
def test_create_space(db_connection):
    ...
    assert repository.find_by_id(3) == Space(3,'The Manor','A fancy manor house',100,2)
